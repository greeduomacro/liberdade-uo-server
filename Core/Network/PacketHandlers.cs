...
namespace Server.Network
{
	...
	public static class PacketHandlers
	{
		...
		static PacketHandlers()
		{
            ...
            Register( 0xE7, 0, false, new OnPacketReceive( HighlightUI3D ));
            Register( 0xE8, 0, false, new OnPacketReceive( RemoveHighlightUI3D ));
            Register( 0xEA, 0, false, new OnPacketReceive( EnableHotbar3D ));
            //Register( 0xEB, 0, false, new OnPacketReceive( UseHotbar3D ));
            Register(0xEC, 0, false, new OnPacketReceive(EquipMacro));
            Register(0xED, 0, false, new OnPacketReceive(UnequipMacro));
            Register( 0xFF, 4, false, new OnPacketReceive( Seed3D ));
            ...
            //RegisterExtended( 0x31, true, new OnPacketReceive( StartHotbarSlow3D ));
            #endregion
        ...
        //UOSA
        public static void HideWaypoint3D(NetState state, PacketReader pvSrc)
        {
            int obj_serial = pvSrc.ReadInt32();
        }

        //UOSA
        public static void HighlightUI3D(NetState state, PacketReader pvSrc)
        {
            int mobile_serial = pvSrc.ReadInt32();
            int ui_elementID = pvSrc.ReadInt16();
            int dest_objSerial = pvSrc.ReadInt32();
            int unk1 = pvSrc.ReadByte();
        }

        //UOSA
        public static void RemoveHighlightUI3D(NetState state, PacketReader pvSrc)
        {
            int mobile_serial = pvSrc.ReadInt32();
            int ui_elementalID = pvSrc.ReadInt16();
            int dest_objSerial = pvSrc.ReadInt32();
            int unk1 = pvSrc.ReadByte();
            int unk2 = pvSrc.ReadByte();

        }

        // UOSA - A implementar
        public static void EncryptionRequest3D(NetState state, PacketReader pvSrc)
        {
        ...
        // UOSA
        public static void ToggleHighlightUI3D(NetState state, PacketReader pvSrc)
        {
            int ui_elementID = pvSrc.ReadInt16();
            int mobile_serial = pvSrc.ReadInt32();
            string description = pvSrc.ReadString(64);
            int commandID = pvSrc.ReadInt32();
        }

        // UOSA
        public static void EnableHotbar3D(NetState state, PacketReader pvSrc)
        {
            int enable_hotbar = pvSrc.ReadInt16();
        }
